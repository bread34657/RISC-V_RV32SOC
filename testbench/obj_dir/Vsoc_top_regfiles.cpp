...
void Vsoc_top_regfiles::readRegister(uint32_t raddr, uint32_t& val) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vsoc_top_regfiles::readRegister\n"); );
    // Body
    val = this->__PVT__x[(0x1fU & raddr)];
}

VL_INLINE_OPT void Vsoc_top_regfiles___settle__TOP__soc_top__coretop0__regfiles0__1(Vsoc_top_regfiles* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsoc_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vsoc_top_regfiles___settle__TOP__soc_top__coretop0__regfiles0__1\n"); );
    // Body
    vlSelf->__PVT__we = ((IData)(vlSymsp->TOP__soc_top__coretop0.__PVT__wbreg_we) 
                         & (0U != (IData)(vlSymsp->TOP__soc_top__coretop0.__PVT__wbreg_rdaddr)));
}

VL_INLINE_OPT void Vsoc_top_regfiles___sequent__TOP__soc_top__coretop0__regfiles0__2(Vsoc_top_regfiles* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vsoc_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vsoc_top_regfiles___sequent__TOP__soc_top__coretop0__regfiles0__2\n"); );
    // Variables
    ...
    if (vlSymsp->TOP.rst_i) {
        ...
        __Vdlyvval__x__v32 = vlSymsp->TOP__soc_top__coretop0.__PVT__wbreg_rddata;
        __Vdlyvset__x__v32 = 1U;
        __Vdlyvdim0__x__v32 = vlSymsp->TOP__soc_top__coretop0.__PVT__wbreg_rdaddr;
    }
